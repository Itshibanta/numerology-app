...
// Retourne le client_secret d'une session Checkout "embedded" (paiement
// intégré dans la page, sans redirection vers Stripe).
export async function createOneShotCheckout(payload: OneShotPayload): Promise<string> {
